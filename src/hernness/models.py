"""Public, serializable domain models for Hernness."""
...
from hernness.state import RunState, StopReason, is_terminal, validate_terminal_outcome


def new_id() -> str:
    """Return a UUID4 encoded as a canonical string.

    Hernness consistently represents UUID identifiers as strings at public and
