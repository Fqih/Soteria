"""State-machine handlers for :mod:`hernness.runtime`.
...
from hernness.events import EventType
...
from hernness.hooks import HookAction, HookContext, HookEvent
from hernness.models import ModelRequest, ToolResult, utc_now
from hernness.state import RunState, StopReason
from hernness.tools import tool_call_fingerprint

if TYPE_CHECKING:
    from hernness.runtime import AgentRuntime, _RunContext
...
async def handle_model_pending(runtime: AgentRuntime, context: _RunContext) -> None:
    ...
    try:
        ...
        from hernness.models import ModelResponse
