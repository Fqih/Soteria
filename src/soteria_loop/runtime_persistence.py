"""Persistence helpers for :mod:`soteria_loop.runtime`.
...
from soteria_loop.exceptions import UnsafeResumeError
from soteria_loop.models import (
    Checkpoint,
    RunRecord,
    ToolResult,
)
from soteria_loop.providers.base import StatefulModelProvider
from soteria_loop.state import RunState, StopReason, is_terminal, validate_transition

if TYPE_CHECKING:
    from soteria_loop.runtime import AgentRuntime, _RunContext
