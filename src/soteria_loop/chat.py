...
The setup wizard lives in :mod:`soteria_loop.chat_setup` and the
shell-rc persistence helpers live in :mod:`soteria_loop.chat_shell_rc`.
Both modules are re-exported here for backward compatibility with
existing imports (``from soteria_loop.chat import interactive_first_run_setup``)
...
from soteria_loop import runtime as _runtime  # noqa: F401  (typing hook)
...
from soteria_loop.chat_setup import interactive_first_run_setup  # re-export
from soteria_loop.chat_shell_rc import (  # re-export
