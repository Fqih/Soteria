...
class SQLiteEventStore:
    ...
    async def save_checkpoint(
        ...
        from soteria_loop.storage.sqlite_checkpoints import save_checkpoint as _save
    ...
    async def get_latest_checkpoint(self, run_id: str) -> Checkpoint | None:
        ...
        from soteria_loop.storage.sqlite_checkpoints import get_latest_checkpoint as _get
