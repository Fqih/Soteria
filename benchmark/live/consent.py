...
* The ``SOTERIA_I_UNDERSTAND_THIS_COSTS_MONEY`` environment variable, which
...
COST_CONSENT_ENV = "SOTERIA_I_UNDERSTAND_THIS_COSTS_MONEY"
...
def has_cost_consent(flag: bool, environ: Mapping[str, str]) -> bool:
    ...
    Args:
        ...
        environ: Mapping consulted for ``SOTERIA_I_UNDERSTAND_THIS_COSTS_MONEY``.
