...
def test_main_prints_summary_and_one_trace_example(
    ...
    original_soteria = cli_module.run_soteria
    original_interrupted = cli_module.run_soteria_interrupted
    cli_module.run_raw_loop = raw_runner  # type: ignore[assignment]
    cli_module.run_soteria = soteria_runner  # type: ignore[assignment]
    cli_module.run_soteria_interrupted = interrupted_runner  # type: ignore[assignment]
    try:
        code = main(
            [
                "--provider",
        ...
        cli_module.run_soteria = original_soteria
        cli_module.run_soteria_interrupted = original_interrupted
