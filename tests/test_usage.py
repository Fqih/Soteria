...
from avo.usage import UsageRecord, UsageTracker, estimate_cost, merge
...
def test_estimate_cost_uses_env(
    ...
    monkeypatch.setenv("AVO_USAGE_RATES_INPUT_PER_1K", "0.005")
    monkeypatch.setenv("AVO_USAGE_RATES_OUTPUT_PER_1K", "0.015")
...
def test_estimate_cost_handles_bad_env(
    ...
    monkeypatch.setenv("AVO_USAGE_RATES_INPUT_PER_1K", "not-a-number")
    monkeypatch.setenv("AVO_USAGE_RATES_OUTPUT_PER_1K", "")
