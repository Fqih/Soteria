...
from avo.app_tools.plan_tasks import PlanTasksArguments, plan_tasks_tool
from avo.planning import SubTask, Task


@pytest.fixture(autouse=True)
def _reset_plan_state() -> None:
    from avo.app_tools.plan_tasks import reset_active_plan
...
async def test_plan_tasks_complete_without_plan_raises() -> None:
    tool = plan_tasks_tool()
    from avo.planning import PlanError
